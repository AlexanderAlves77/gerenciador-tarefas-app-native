  ...
  const renderContent = () => (
    <>
      <Image
        ...
        source={
          dataConclusao
            ? require('../assets/images/concluido.png')
      ...
      <View>
        <Text
          style={[
            itemStyles.text,
            dataConclusao ? itemStyles.textConcluido : null,
          ]}
        >
          {item.nome}
        </Text>

        <Text style={itemStyles.textData}>
          {getDataTexto(dataConclusao, dataPrevistaConclusao)}
        </Text>
      </View>
    </>
  )
